    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-tickets"></i> 教师管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="userId" label="教师编号" width="55" align="center" v-if="false"></el-table-column>
...
<!--                        >删除</el-button>-->
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                <el-form-item label="教师编号" v-if="false">
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                axios
                    .post(
                        "http://121.196.49.85:9999/daoyunWeb/teacher/getTeacherByPage",
                        {
            ...
            getDataCount() {
                ...
                axios
                    .post(
                        "http://121.196.49.85:9999/daoyunWeb/teacher/getTeacherCount",
                        { userName: this.query.userName },
                        { headers: { "Content-Type": "application/json" } }
                    )
                    .then(
            ...
            updateTeacher() {
                axios
                    .post(
                        "http://121.196.49.85:9999/daoyunWeb/teacher/updateTeacherJson",
                        {
            ...
            addTeacher(){
                axios
                    .post(
                        "http://121.196.49.85:9999/daoyunWeb/teacher/addTeacherJson",
                        {
