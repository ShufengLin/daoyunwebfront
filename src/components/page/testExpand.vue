...
export default {
  ...
  methods: {
    ...
    getData() {
      //TODO 待加入搜索限定参数
      // axios
      //   .get("http://121.196.49.85:9999/daoyunWeb/testExample/getAllPaper")
      //   .then(
      //     res => {
      //       console.log(res);
      ...
      axios
        .post(
          "http://121.196.49.85:9999/daoyunWeb/testExample/getPaperByPage",
          {
    ...
    getDataCount() {
      ...
      axios
        .post(
          "http://121.196.49.85:9999/daoyunWeb/testExample/getPaperCount",
          { paperName: this.query.paperName },
          { headers: { "Content-Type": "application/json" } }
        )
        .then(
    ...
    updatePaper() {
      axios
        .post(
          "http://121.196.49.85:9999/daoyunWeb/testExample/updatePaperJson",
          {
    ...
    addPaper() {
      axios
        .post(
          "http://121.196.49.85:9999/daoyunWeb/testExample/addPaperJson",
          {
    ...
    deletePaper() {
      ...
      axios
        .post(
          "http://121.196.49.85:9999/daoyunWeb/testExample/deletePaperJson/" +
            this.form.paperId
        )
        .then(
          res => {
    ...
    deletePaperBatch() {
      axios
        .post(
          "http://121.196.49.85:9999/daoyunWeb/testExample/deletePaperBatchJson",
          this.delIdList,
          { headers: { "Content-Type": "application/json" } }
        )
        .then(
